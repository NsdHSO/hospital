...
pub async fn find_all(
    ...
    let service_instance = StaffService::new(db_conn.get_ref());
    ...
    let hospital_option_string: Option<&String> = params.get("hospital_id");
    ...
    let hospital_str: Option<&str> = hospital_option_string.map(String::as_str);
